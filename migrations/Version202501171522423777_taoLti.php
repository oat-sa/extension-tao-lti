 ...
 */
final class Version202501171522423777_taoLti extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Apply launch permissions for ContentExpert role';
    }
    ...
    private function updateCache(): void
    {
        ...
        core_kernel_users_Cache::removeIncludedRoles(
            new core_kernel_classes_Resource(LtiRoles::CONTEXT_LTI1P3_CONTENT_DEVELOPER_SUB_CONTENT_EXPERT)
        );
